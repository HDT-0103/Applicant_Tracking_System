...
export const jobsMessages = {
  ...
  "jobs.detail.tab.ranking": { en: "Ranking", vi: "Xếp hạng" },
  "jobs.ranking.empty": { en: "No applications yet.", vi: "Chưa có hồ sơ nào nộp vào tin này." },
  "jobs.ranking.loadError": { en: "Could not load the ranking.", vi: "Không tải được bảng xếp hạng." },
  "jobs.ranking.note": {
    en: "Ranked by how well the CV matches this posting (summary and experience vs the job description). New applications are scored in the background within about a minute.",
    vi: "Xếp theo mức khớp giữa CV và tin này (tóm tắt và kinh nghiệm so với mô tả công việc). Hồ sơ mới được chấm ở nền trong khoảng một phút.",
  },
  "jobs.ranking.unscored": { en: "Not scored yet", vi: "Chưa chấm" },
  "jobs.ranking.match": { en: "match", vi: "khớp" },
  "jobs.ranking.summary": { en: "Summary", vi: "Tóm tắt" },
  "jobs.ranking.experience": { en: "Experience", vi: "Kinh nghiệm" },
  "jobs.ranking.mustHave": { en: "Must-have", vi: "Bắt buộc" },
  "jobs.ranking.submitted": { en: "Applied {date}", vi: "Nộp {date}" },
