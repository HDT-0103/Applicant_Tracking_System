...
export const candidateMessages = {
  ...
  "candidate.chat.empty": {
    en: "Search candidates in your workspace, or ask how SmartATS works.",
    vi: "Tìm ứng viên trong phạm vi của bạn, hoặc hỏi cách SmartATS hoạt động.",
  },
  "candidate.chat.emptyCandidate": {
    en: "Start with a question about this candidate, or type your own.",
    vi: "Bắt đầu bằng một câu hỏi về ứng viên này, hoặc tự gõ câu hỏi.",
  },
  ...
  "candidate.chat.about": { en: "About Candidate #{code}", vi: "Về ứng viên #{code}" },
  "candidate.chat.general": { en: "Search & general questions", vi: "Tìm ứng viên & hỏi chung" },
  "candidate.chat.newConversation": { en: "New conversation", vi: "Cuộc trò chuyện mới" },
  "candidate.chat.followUps": { en: "You could ask next", vi: "Có thể hỏi tiếp" },
  "candidate.chat.starters": { en: "Ask about this candidate", vi: "Hỏi về ứng viên này" },
  "candidate.chat.startersGeneral": { en: "Try asking", vi: "Thử hỏi" },
  "candidate.chat.starter.summary": { en: "Summarise this candidate's profile", vi: "Tóm tắt hồ sơ ứng viên này" },
  "candidate.chat.starter.strengths": { en: "Summarise their standout strengths", vi: "Tóm tắt điểm mạnh nổi bật" },
  "candidate.chat.starter.gaps": { en: "What's missing versus the job requirements?", vi: "Thiếu gì so với yêu cầu của tin tuyển dụng?" },
  "candidate.chat.starter.interview": { en: "Suggest 5 interview questions", vi: "Gợi ý 5 câu hỏi phỏng vấn" },
  "candidate.chat.starter.risks": { en: "What risks should we verify?", vi: "Rủi ro nào cần kiểm tra thêm?" },
  "candidate.chat.starter.github": { en: "Assess technical skills from GitHub", vi: "Đánh giá kỹ năng kỹ thuật qua GitHub" },
  "candidate.chat.starter.findBackend": { en: "Find senior backend engineers with Python", vi: "Tìm senior backend engineer biết Python" },
  "candidate.chat.starter.findBest": { en: "Who are the strongest candidates for my open posting?", vi: "Ai là ứng viên mạnh nhất cho tin đang tuyển?" },
  "candidate.chat.starter.findSkills": { en: "Find candidates with React and TypeScript", vi: "Tìm ứng viên biết React và TypeScript" },
  "candidate.chat.starter.overview": { en: "Give me an overview of my job postings", vi: "Tổng quan các tin tuyển dụng của tôi" },
  "candidate.chat.starter.howScoring": { en: "How are candidates scored and reviewed?", vi: "Ứng viên được chấm điểm và duyệt thế nào?" },
