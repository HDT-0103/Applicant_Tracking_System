...
from src.backend.app.schemas.ingestion_event import IngestionEvent, IngestionEventType
from src.backend.app.services.websocket_manager import manager
...
class IngestionGateway:
    ...
    async def run_job(self, job_id: str, db_client: Client):
        ...
        try:
            ...
            await self._emit_progress(
                job_id,
                IngestionEventType.AI_ANALYTICS_COMPLETE,
                data=final_analytics_payload,
            )
    ...
    async def _emit_progress(
        self, job_id: str, event_type: IngestionEventType, data: Any = None
    ):
